...
const SprintRingGame = () => {
    ...
    return [
      ...
      },
      {
        ...
        component: (
          <FreeApi
            src={
              "https://sanbul-team2-fortune-wheel.vercel.app/?api=6ec0bd7f-11c0-43da-975e-2a8ad9ebae0b"
            }
          />
        ),
      },
  ...
  return (
    <>
      <Helmet>
        <title> General: Home | Wheel - Game</title>
      </Helmet>
      ...
      <Container maxWidth={"xl"}>
        ...
        <iframe
          src="https://sanbul-team2-fortune-wheel.vercel.app/?api=6ec0bd7f-11c0-43da-975e-2a8ad9ebae0b"
          width="100%"
          height="700px"
          frameBorder="0"
          scrolling="no"
